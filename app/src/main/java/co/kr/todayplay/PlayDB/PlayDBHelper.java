...
public class PlayDBHelper extends SQLiteOpenHelper {
    ...
    //insert
    public void insert_Perform(int play_id, String play_title, String play_category, String play_main_poster, int play_main_journal_file, String play_journal_thumbnail1_img, String play_journal_thumbnail2_img,String play_keywords, String play_youtube_links,String play_crew, int num_of_heart, String relative_journal  ) {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("INSERT INTO Play (play_id, play_title, play_category, play_main_poster, play_main_journal_file, play_journal_thumbnail1_img, play_journal_thumbnail2_img,play_keywords, play_youtube_links, play_crew, num_of_heart,relative_journal) Values('" + play_id + "','" + play_title + "','" + play_category + "','" + play_main_poster + "','" + play_main_journal_file + "','" + play_journal_thumbnail1_img + "','" + play_journal_thumbnail2_img + "','" + play_keywords + "','" + play_youtube_links + "','"+play_crew+"','"+num_of_heart+"','" + play_main_poster + "');");
        Log.d("insert_play", "insert_play: " + play_id + "|" + play_title + "|" + play_category + "|" + play_main_poster + "|" + play_main_journal_file + "|" + play_journal_thumbnail1_img + "|" + play_journal_thumbnail2_img + "|" + play_keywords + "|" + play_youtube_links + "|" + play_crew + "|" + num_of_heart + "|" + relative_journal + "|" );
