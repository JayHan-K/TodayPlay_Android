...
public class PerformReviewImageAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PerformReviewImageAdapter2(ArrayList<String> data, Context mContext){
        super();
        this.data = data;
        this.mContext = mContext;
    }
    public PerformReviewImageAdapter2(ArrayList<String> data){
        super();
        this.data = data;
    }
    @NonNull
